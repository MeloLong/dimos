...
class Go2Memory91Config(RecorderConfig):
    db_path: str | Path = "recording_go2.db"


class Go2Memory91(Recorder):
    color_image: In[Image]
    lidar: In[PointCloud2]
    odom: In[PoseStamped]
    config: Go2Memory91Config


unitree_go2_91_markers = (
    autoconnect(
        unitree_go2_91,
...
unitree_go2_91_relocalization = autoconnect(
    unitree_go2_91,
    RelocalizationModule.blueprint(),
).global_config(n_workers=11)

unitree_go2_91_memory = autoconnect(
    unitree_go2_91,
    Go2Memory91.blueprint(),
